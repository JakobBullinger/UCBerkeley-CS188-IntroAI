...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        "*** YOUR CODE HERE ***"
        # Compute most likely position of each ghost
        mostLikelyGhostPositions = []
        for beliefs in livingGhostPositionDistributions:
            mostLikelyPosition = max(beliefs, key=beliefs.get)
            mostLikelyGhostPositions.append(mostLikelyPosition)

        # Iterate thorugh possible successor actions
        actionsDictionary = {}
        for action in gameState.getLegalPacmanActions():
            ...
            for ghostPosition in mostLikelyGhostPositions:
                ...
                minDistance = min(minDistance, mazeDistance)
            actionsDictionary[action] = minDistance

        # Determine best action
        bestAction = min(actionsDictionary, key=actionsDictionary.get)
        return bestAction
        "*** END YOUR CODE HERE ***"
